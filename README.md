...
You can visit http://54.198.110.145/ or http://54.198.110.145/college  or http://ec2-54-198-110-145.compute-1.amazonaws.com/ for the website deployed.
...
### Step 1: Start a new Ubuntu Linux server instance on Amazon EC2 
  ...
  - Check for instance IPv4 public IP - 54.198.110.145
  - we can download a .pem file and connect with following command
    ```
    ssh -i linux_server_itemcatalog_b1.pem ubuntu@54.198.110.145
    ``` 
...
- To check port 2200 wether working or not by `ssh -i linux_server_itemcatalog_b1.pem -p 2200 ubuntu@54.198.110.145` 
...
### Step 7: Create an SSH key pair for `grader`
  ...
  - Restart SSH: `sudo service ssh restart`
  - On the local machine, cheking if the grader account working or not by running this command : `ssh -i linux_server_itemcatalog_b1.pem -p 2200 ubuntu@54.198.110.145`.
...
`sudo git clone https://github.com/pavankumarnarendravarapu/catalog.git`.
...
- We need to change sqlite to postgresql create_engine in `__init__.py`,`college_database.py` and `college_info.py`,
   ```
...
- Click `Credentials`.
- Create an OAuth Client ID (under the Credentials tab), and add http://54-198-110-145.xip.io and 
http://ec2-54-198-110-145.compute-1.amazonaws.com/ as authorized JavaScript 
origins.
- Add http://54.198.110.145.xip.io/login,http://54.198.110.145.xip.io/gconnect,http://54.198.110.145.xip.io/callback
...
### Step 13.2: Set up and enable a virtual host
  ...
  ```
  <VirtualHost *:80>
      ServerName 54.198.110.145.xip.io
      ServerAlias ec2-54-198-110-145.compute-1.amazonaws.com
      ServerAdmin ubuntu@54.198.110.145
...
- Open your browser to http://54.198.110.145 or http://ec2-54-198-110-145.us-east-2.compute.amazonaws.com.
